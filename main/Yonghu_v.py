            ...
            try:
                for row in range(1, rows):
                    ...
                    if '.0' in str(row_values[2]):
                        req_dict['fullname'] = str(row_values[2]).split('.')[0]
                    elif str(row_values[2]) != '':
                        req_dict['fullname'] = row_values[2]
                    else:
                    ...
                    if '.0' in str(row_values[4]):
                        req_dict['shouji'] = str(row_values[4]).split('.')[0]
                    elif str(row_values[4]) != '':
                        req_dict['shouji'] = row_values[4]
                    else:
                        req_dict['shouji'] = None
                    if '.0' in str(row_values[5]):
                        req_dict['zhuzhi'] = str(row_values[5]).split('.')[0]
                    elif str(row_values[5]) != '':
                        req_dict['zhuzhi'] = row_values[5]
                    else:
                        req_dict['zhuzhi'] = None
