...
<style>
	* {
	...
	.breadcrumb-preview .el-breadcrumb .item1 .el-breadcrumb__inner a {
		color: #000;
		background: url(http://codegen.caihongy.cn/20250122/d9cec1b0afa741b8af525aa028823772.png) no-repeat center top / 100% 100%;
	...
	.breadcrumb-preview .el-breadcrumb .item2 .el-breadcrumb__inner a {
		color: #111;
		background: url(http://codegen.caihongy.cn/20250122/1bc196d298ff4b00908135aa2033cb10.png) no-repeat center top / 100% 100%;
		display: inline-block;
		line-height: 24px;
		min-width: 110px;
		text-align: center;
