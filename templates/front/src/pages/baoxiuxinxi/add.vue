	...
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="报修编号" prop="bianhao">
				<el-input v-model="ruleForm.bianhao" placeholder="报修编号" disabled></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item"  label="紧急程度" prop="jinjichengdu">
				<el-select v-model="ruleForm.jinjichengdu" placeholder="请选择紧急程度" :disabled=" false  ||ro.jinjichengdu" >
					<el-option
			...
			<el-form-item class="add-item" label="姓名" prop="fullname">
				<el-input v-model="ruleForm.fullname" 
					placeholder="姓名" clearable :disabled=" false  ||ro.fullname"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="报修时间" prop="baoxiushijian">
				<el-date-picker
					:disabled=" false  ||ro.baoxiushijian"
			...
			<el-form-item class="add-item"  label="请求进度" prop="qingqiujindu">
				<el-select v-model="ruleForm.qingqiujindu" placeholder="请选择请求进度" :disabled="true  ||ro.qingqiujindu" >
					<el-option
			...
			async onSubmit() {
				...
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`baoxiuxinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
