<template>
	<div class="center-preview">
		...
		<div class="center-info">
			...
			<div class="img-box" v-if="userTableName=='shequrenyuan'">
				<img :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')">
			</div>
			...
			<div class="info-item2" v-if="userTableName=='yonghu'">
				...
				<div class="text">{{sessionForm.fullname}}</div>
			</div>
		...
		<el-tabs class="center-tabs" tab-position="left" @tab-click="handleClick">
			<el-tab-pane label="个人中心">
				<el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="180px">
					...
					<el-form-item class="center-item" v-if="userTableName=='yonghu'" label="姓名" prop="fullname">
						<el-input v-model="sessionForm.fullname" placeholder="姓名" ></el-input>
					</el-form-item>
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.center-preview {
		...
		.center-info {
			...
			background: url(http://codegen.caihongy.cn/20250122/0d3cecc1dd0f4caf8fcf58a03d61e84b.png) no-repeat center top / 100% 100%;
			width: 100%;
			...
			.info-item1 {
				...
				background: url(http://codegen.caihongy.cn/20250122/c6c4e0b935864c5683e77b12ff8d53c9.png) no-repeat center top / 100% 100%;
				display: flex;
				width: auto;
				border-color: #ddd;
				border-width: 0 0 0px 0;
		...
		.center-tabs.el-tabs {
			...
			/deep/ .el-tabs__header .el-tabs__item:hover {
				border: 0;
				color: #fff;
				background: url(http://codegen.caihongy.cn/20250122/649226eb56ef4d4f9556b2355d605669.png)  no-repeat center top / 100% 100%;
			}
