	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">基于django的社区设备报修住户反馈智能预测系统设计</span>
				</div>
		...
		async getSession() {
			await this.$http.get(`${localStorage.getItem('UserTableName')}/session`, {emulateJSON: true}).then(async res => {
				if (res.data.code == 0) {
					...
					if(localStorage.getItem('UserTableName')== 'shequrenyuan') {
						localStorage.setItem('username', res.data.data.shequzhanghao);
					}
	...
	.main-containers {
		.body-containers {
			...
			.top-container {
				...
				top: 0;
				left: 0;
				background: url(http://codegen.caihongy.cn/20250112/5a2461ea7547400c8fcfeb9bb2a77dff.png) repeat-x center bottom,url(http://codegen.caihongy.cn/20250110/8bc7f686c9494cd8ada039db14ea966d.jpg) repeat,#fff;
				width: 100%;
				...
				.menu-list {
					...
					.menu-home {
						...
						.title {
							...
							padding: 0 20px;
							color: #000;
							background: url(http://codegen.caihongy.cn/20250112/64ecb99dd3524cbe8b5664c4a4de1e58.png) no-repeat right center / auto 100%;
							display: flex;
							.icon {
								padding: 0 10px;
								margin: 0;
					...
					.menu-home:hover {
						.title {
							color: #848c74;
							background: url(http://codegen.caihongy.cn/20250112/b7f07c75ea4a457ba25f97ae35e150b8.png) no-repeat right center / auto 100%,#fff;
						}
					}
			...
			.bottom-preview {
				...
				.footer {
					...
					overflow: hidden;
					color: #fff;
					background: url(http://codegen.caihongy.cn/20250120/b9fa609d84e1471e8eead3b16332dd3c.jpg);
					width: 100%;
					min-height: 120px;
					text-align: center;
					height: auto;
