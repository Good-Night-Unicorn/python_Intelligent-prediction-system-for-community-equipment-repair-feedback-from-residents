<template>
	<div :style='{"padding":"0 0 20px","margin":"0px auto","color":"#666","background":"#f6f6f6","width":"1200px","fontSize":"16px","position":"relative"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 0 110px","margin":"30px auto 20px","color":"#000","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250122/b447b24b79d943db9940fa5642860503.png) no-repeat left center /1200px 100%","width":"100%","lineHeight":"80px","fontSize":"28px","position":"relative","fontWeight":"600","height":"108px"}'>我的收藏</div>
