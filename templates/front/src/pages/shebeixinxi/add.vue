	...
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item"  label="设备类型" prop="shebeileixing">
				<el-select v-model="ruleForm.shebeileixing" placeholder="请选择设备类型" :disabled=" false  ||ro.shebeileixing" >
					<el-option
			...
			<el-form-item class="add-item" label="设备功能" prop="shebeigongneng">
				<el-input v-model="ruleForm.shebeigongneng" 
					placeholder="设备功能" clearable :disabled=" false  ||ro.shebeigongneng"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="设备详情" prop="shebeixiangqing">
				<editor 
			...
			init(type) {
				...
				if(type=='cross'){
					...
					for (var o in obj){
						...
						if(o=='shebeitupian'){
							this.ruleForm.shebeitupian = obj[o].split(",")[0];
							this.ro.shebeitupian = true;
							continue;
						}
						if(o=='shebeigongneng'){
							this.ruleForm.shebeigongneng = obj[o];
							this.ro.shebeigongneng = true;
							continue;
						}
				...
				this.$http.get('option/shebeileixing/shebeileixing', {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
						this.shebeileixingOptions = res.data.data;
					}
				});
			...
			async onSubmit() {
				...
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`shebeixinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
