<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0 30px","margin":"10px 0 10px","borderRadius":"4px","background":"#fff","display":"block","width":"100%","lineHeight":"40px","height":"40px"}'>
