<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"90px 30px 20px 260px","margin":"0","position":"relative","background":"#E3E3E3","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"border":"1px solid #A8A8A8","alignItems":"center","color":"#000","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#fff","width":"100vw","fontSize":"18px","position":"fixed","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"100%","padding":"12px 0 12px 10px","fontSize":"16px","borderRadius":"4px","background":"#fff"}' class="bread-crumbs"></bread-crumbs>
