		...
		<div class="login-container">
			<el-form class="login_form animate__animated animate__backInDown">
				<div class="login_form2">
					<div class="title-container">基于django的社区设备报修住户反馈智能预测系统设计登录</div>
					...
					<div class="login-btn">
						...
						<div class="login-btn2">
							<el-button type="primary" @click="register('shequrenyuan')" class="register">
								注册社区人员							</el-button>
						</div>
...
.login-container {
	...
	background: url(http://codegen.caihongy.cn/20240906/ebe3f0158d3145228c412d0408eea9a9.gif);
	background-repeat: no-repeat;
	background-size: cover;
	background: url(http://codegen.caihongy.cn/20240906/ebe3f0158d3145228c412d0408eea9a9.gif);
	display: flex;
