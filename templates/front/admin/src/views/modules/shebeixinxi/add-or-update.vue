	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="设备功能" prop="shebeigongneng" >
					<el-input v-model="ruleForm.shebeigongneng" placeholder="设备功能" clearable  :readonly="ro.shebeigongneng"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="设备功能" prop="shebeigongneng" >
					<el-input v-model="ruleForm.shebeigongneng" placeholder="设备功能" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.shebeixiangqing" label="设备详情" prop="shebeixiangqing" >
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.shebeixiangqing = this.ruleForm.shebeixiangqing.replace(reg,'../../../django1pyj28qj/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
